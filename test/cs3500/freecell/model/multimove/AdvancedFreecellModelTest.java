...
/**
 * JUnit test cases for only the advanced freecell model.
 */
public class AdvancedFreecellModelTest {
  FreecellModelCreator creator = new FreecellModelCreator();
  FreecellModel<Card> model = creator.create(FreecellModelCreator.GameType.MULTIMOVE);
  ArrayList<Card> deck = new ArrayList<>();


  @Test
  public void creatorType() {
    assertTrue(model instanceof AdvancedFreecellModel);
  }
  ...
  @Test
  public void validMultiMove() {
    model.startGame(model.getDeck(),8,4,false);
    model.move(PileType.CASCADE, 2, 6,PileType.OPEN,0);
    model.move(PileType.CASCADE, 2, 5,PileType.CASCADE,4);
    model.move(PileType.CASCADE, 4, 5,PileType.CASCADE,3);
    FreecellTextView view = new FreecellTextView(model);
    assertEquals("F1:\n" +
            "F2:\n" +
  ...
  @Test (expected = IllegalArgumentException.class)
  public void InvalidMultiMoveBadBuild() {
    model.startGame(model.getDeck(),8,4,false);
    model.move(PileType.CASCADE, 2, 6,PileType.OPEN,0);
    model.move(PileType.CASCADE, 2, 5,PileType.CASCADE,4);
    model.move(PileType.CASCADE, 4, 5,PileType.CASCADE,3);
    model.move(PileType.CASCADE, 5, 4,PileType.CASCADE,3);

  }

  @Test (expected = IllegalArgumentException.class)
  public void invalidMultiMoveNoCardMatch() {
    model.startGame(model.getDeck(),8,4,false);
    model.move(PileType.CASCADE, 2, 6,PileType.OPEN,0);
    model.move(PileType.CASCADE, 2, 5,PileType.CASCADE,4);
    model.move(PileType.CASCADE, 4, 5,PileType.CASCADE,3);
    model.move(PileType.CASCADE, 2, 4,PileType.CASCADE,4);
  ...
  @Test (expected = IllegalArgumentException.class)
  public void invalidMultiMoveTooManyCards() {
    model.startGame(model.getDeck(),8,4,false);
    model.move(PileType.CASCADE, 2, 6,PileType.OPEN,0);
    model.move(PileType.CASCADE, 2, 5,PileType.CASCADE,4);
    model.move(PileType.CASCADE, 4, 5,PileType.CASCADE,3);
    ...
    model.move(PileType.CASCADE, 2, 2,PileType.OPEN,2);
    model.move(PileType.CASCADE, 1, 3,PileType.OPEN,3);
    model.move(PileType.CASCADE, 4, 4,PileType.CASCADE,3);
  }
